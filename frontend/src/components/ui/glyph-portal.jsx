 ...
 *
 * JavaScript port of the original TypeScript source. The public API is unchanged;
 * see the JSDoc on GlyphPortal below for the prop contract the types used to carry.
 */
 ...
 * @param {string} [props.focusChar] First matching character. Omit to choose the largest safe patch of ink.
 * @param {boolean} [props.interactive] Hover, tap, or use arrow keys to choose a letter before scrolling.
 * @param {React.ReactNode} [props.background] Decorative, inert, mounted once. Fill its parent with an image, video, or canvas.
 * @param {React.ReactNode} [props.front] Optional foreground composition for the opening frame, above the clipped scene.
 * @param {React.ReactNode} [props.children]
 * @param {number} [props.scrollLength] Scroll travel in visible container heights, clamped to 1–8.
 * @param {string} [props.fontFamily]
 * @param {number} [props.fontWeight]
 * @param {boolean} [props.annotations]
 * @param {string} [props.enterLabel]
 * @param {string} [props.className]
 * @param {React.CSSProperties} [props.style] Also accepts --gp-paper, --gp-ink, --gp-field, --gp-foreground.
 * @param {(progress: number) => void} [props.onProgress] Called once per rendered scroll frame, never through React state.
 */
